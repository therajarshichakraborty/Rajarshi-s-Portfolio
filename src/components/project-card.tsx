          ...
          <div className="flex flex-col gap-1.5">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {isBuilding ? (
                ...
                <span className="inline-flex items-center gap-1.5 px-3 py-1 text-[10px] tracking-widest uppercase font-bold rounded-full bg-lime-500/10 dark:bg-lime-400/15 text-lime-600 dark:text-lime-400 border border-lime-500/30 dark:border-lime-400/30 shadow-[0_0_12px_rgba(132,204,22,0.25)] backdrop-blur-md select-none">
                  <span className="relative flex h-2 w-2">
