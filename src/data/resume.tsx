  ...
  projects: [
    {
      ...
      active: true,
      description:
        "Synapse UI is a modern React UI library built with Next.js, TypeScript, and FumaDocs, designed to help developers build beautiful, production-ready applications faster. It offers reusable components with both copy-paste support and seamless CLI installation through ShadCN for a flexible developer experience.",
      technologies: [
        "Next.js",
        "Typescript",
        "FumaDocs",
    ...
    },
    {
      ...
      active: true,
      description:
        "Built an AI-powered LinkedIn content generation platform using Streamlit, LangChain, and Groq LLMs, enabling intelligent post creation through scalable prompt pipelines, real-time AI inference, and interactive user workflows.",
      technologies: [
        "LangChain",
        "Python",
        "Pydantyc",
