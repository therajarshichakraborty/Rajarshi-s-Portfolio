...
export const DATA = {
  ...
  summary: `**Hello :)** I’m **Rajarshi Chakraborty**, a Software Engineer at Brand Voy and a **Computer Science** undergraduate at Techno Main Salt Lake ( Class of 2027 ), passionate about building scalable **software and intelligent systems**.

I’m a **Full-Stack TypeScript Developer** and **Backend Engineer** focused on designing and developing production-grade applications with clean **architecture**, **high performance**, **scalability**, and strong **System Design** principles.

Beyond traditional engineering, I’m deeply interested in **Generative AI** and **Agentic AI**. I enjoy building AI-powered systems that combine **intelligent automation** with **real-world data** to **solve complex problems** and **create meaningful impact**. I’m driven by continuous learning, engineering excellence, and turning challenging ideas into reliable, practical products.`,
